...
public class DistributionSort<T extends HasAnIntegerKey> {
	...
	public static <T> List<T> countSort(List<T> list, int maxValue) {
		...
		// Walk through the list, build a new list and put each element at the correct index based on its key
		// Note: the initial order of elements with the same key will be preserved (stable search)
